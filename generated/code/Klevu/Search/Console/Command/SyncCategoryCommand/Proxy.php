...
/**
 * Proxy class for @see \Klevu\Search\Console\Command\SyncCategoryCommand
 */
class Proxy extends \Klevu\Search\Console\Command\SyncCategoryCommand implements \Magento\Framework\ObjectManager\NoninterceptableInterface
{
    /**
     ...
     * Proxied instance
     *
     * @var \Klevu\Search\Console\Command\SyncCategoryCommand
     */
     ...
     * @param bool $shared
     */
    public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, $instanceName = '\\Klevu\\Search\\Console\\Command\\SyncCategoryCommand', $shared = true)
    {
     ...
     *
     * @return \Klevu\Search\Console\Command\SyncCategoryCommand
     */
    ...
    {
        return $this->_getSubject()->getInputList();
    }
