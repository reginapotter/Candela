...
namespace Candela\Blog\ViewModel\ReportBuilder;
...
{
    const REPORT_BUILDER_MODULE_NAME = 'Candela_ReportBuilder';
    const PRODUCT_URL = 'https://candela.com/custom-reports-for-magento-2.html';
