...
class PostForm extends \Magento\Framework\App\Action\Action
{
    ...
    /**
     * @var \Candela\Blog\Model\Notification\Notification
     */
    private $notificationModel;

    /**
     * @var \Candela\Blog\Block\Comments\Form
     */
    private $form;
    ...
    public function __construct(
        ...
        \Candela\Blog\Model\Notification\Notification $notificationModel,
        \Candela\Blog\Block\Comments\Form $form,
                ...
                if ($this->getCustomerSession()->getCustomer()->getEntityId()
                    ...
                    if ($newComment) {
                        $message = $this->_view->getLayout()
                            ->createBlock(\Candela\Blog\Block\Comments\Message::class)
