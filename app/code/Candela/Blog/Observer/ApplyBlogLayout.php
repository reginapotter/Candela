...
namespace Candela\Blog\Observer;

use Candela\Blog\Model\ConfigProvider;
use Candela\Blog\Model\Detection\MobileDetection;
use Candela\Blog\Model\Layout\Config;
use Candela\Blog\Model\Layout\Config\PageTypeRelatedModifier;
use Candela\Blog\Model\Layout\ConfigFactory;
use Candela\Blog\Model\Layout\GeneratorInterface;
use Candela\Blog\Model\Layout\LayoutUpdateNameGenerator;
...
class ApplyBlogLayout implements ObserverInterface
{
    ...
    const LISTING_UPDATE = 'candela_blog_listing_pages';
    const POST_UPDATE = 'candela_blog_post_page';
