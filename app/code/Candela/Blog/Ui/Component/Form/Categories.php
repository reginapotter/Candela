...
namespace Candela\Blog\Ui\Component\Form;
...
use Candela\Blog\Controller\Adminhtml\Categories\Edit as EditController;
...
class Categories implements OptionSourceInterface
{
    ...
    public function getCategoriesTree($displayRoot = false)
    {
        if ($this->categoriesTree === null) {
            ...
            if ($category = $this->blogRegistry->registry(EditController::CURRENT_CANDELA_BLOG_CATEGORY)) {
