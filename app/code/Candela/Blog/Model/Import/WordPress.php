...
use Candela\Blog\Controller\Adminhtml\Import\Import as ImportRegistry;
...
class WordPress extends AbstractImport
{
    ...
    public function processImport()
    {
        ...
        try {
            ...
            $this->logger->error(__('Candela Import error: ') . $exception->getMessage());
        }
    }
    ...
    protected function importPosts($data, $connection)
    {
        try {
            ...
            $this->logger->error(__('Candela Import error with Posts: ') . $exception->getMessage());
        }
    }
     ...
     * @param $post
     * @param $connection
     * @return \Candela\Blog\Api\Data\PostInterface
     */
    ...
    protected function importTags($data, $connection)
    {
        try {
            ...
            $this->logger->error(__('Candela Import error with Tags: ') . $exception->getMessage());
        }
    }
    ...
    protected function importCategories($data, $connection)
    {
        try {
            ...
            $this->logger->error(__('Candela Import error with Categories: ') . $exception->getMessage());
        }
    }
    ...
    /**
     * @param $category
     * @return \Candela\Blog\Model\Categories
     */
    ...
    protected function importAuthors($data, $connection)
    {
        try {
            ...
            $this->logger->error(__('Candela Import error with Authors: ') . $exception->getMessage());
        }
    }
    ...
    /**
     * @param $author
     * @return \Candela\Blog\Model\Author
     */
    ...
    protected function importComments($connection)
    {
        try {
            ...
            $this->logger->error(__('Candela Import error with Comments: ') . $exception->getMessage());
        }
    }
