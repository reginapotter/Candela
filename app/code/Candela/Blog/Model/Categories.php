...
{
    public const PERSISTENT_NAME = 'candela_blog_categories';
    ...
    public function _construct()
    {
        ...
        $this->_init(\Candela\Blog\Model\ResourceModel\Categories::class);
    }
    ...
    {
        $identities = [
            \Candela\Blog\Model\Lists::CACHE_TAG,
    ...
    {
        /**
         * @var \Candela\Blog\Model\ResourceModel\Categories\Collection $childrenCollection
         */
