...
class Posts extends AbstractModel implements IdentityInterface, PostInterface
{
    ...
    public const PERSISTENT_NAME = 'candela_blog_posts';
    ...
    /**
     * @var \Candela\Blog\Api\ViewRepositoryInterface
     */
    ...
    /**
     * @param \Candela\Blog\Api\Data\AuthorInterface $author
     * @return $this
     */
    public function setAuthor(\Candela\Blog\Api\Data\AuthorInterface $author)
    {
        $this->setData(PostInterface::AUTHOR, $author);
