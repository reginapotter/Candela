...
use Candela\Blog\Model\CommentsFactory;
use Candela\Blog\Model\ResourceModel\Comments as CommentResource;
...
class CommentRepository implements CommentRepositoryInterface
{
    ...
    private function afterSave(CommentInterface $comment): CommentInterface
    {
        ...
        if ($isNeedNotifyCustomers) {
            $this->eventManager->dispatch('candela_comment_save_after', ['comment' => $comment]);
        }
    ...
    public function getById($commentId)
    {
        if (!isset($this->comments[$commentId])) {
            /** @var \Candela\Blog\Model\Comments $comment */
    ...
    public function getList(SearchCriteriaInterface $searchCriteria)
    {
        ...
        /** @var \Candela\Blog\Model\ResourceModel\Comments\Collection $commentCollection */
