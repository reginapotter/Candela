...
namespace Candela\Blog\Model\Repository;

use Candela\Blog\Api\CategoryRepositoryInterface;
use Candela\Blog\Api\Data\CategoryInterface as CatInterface;
use Candela\Blog\Block\Sidebar\Category\TreeRenderer;
use Candela\Blog\Helper\Settings;
use Candela\Blog\Model\CategoriesFactory;
use Candela\Blog\Model\ResourceModel\Categories as CategoriesResource;
...
class CategoriesRepository implements CategoryRepositoryInterface
{
    ...
    public function getById(int $categoryId): CatInterface
    {
        if (!isset($this->categoriess[$categoryId])) {
            /** @var \Candela\Blog\Model\Categories $categories */
    ...
    public function getList(SearchCriteriaInterface $searchCriteria): SearchResultsInterface
    {
        ...
        /** @var \Candela\Blog\Model\ResourceModel\Categories\Collection $categoriesCollection */
