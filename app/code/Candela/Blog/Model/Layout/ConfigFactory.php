...
use Candela\Blog\Exceptions\LayoutConfigValidationException;
use Candela\Blog\Model\Source\Layout as LayoutSource;
...
class ConfigFactory
{
    ...
    const LAYOUT_NAMES_MAP = [
        LayoutSource::ONE_COLUMN_LAYOUT => 'candela_blog_one_column_layout',
        LayoutSource::TWO_COLUMNS_LEFT_LAYOUT => 'candela_blog_two_column_left_layout',
        LayoutSource::TWO_COLUMNS_RIGHT_LAYOUT => 'candela_blog_two_column_right_layout',
        LayoutSource::THREE_COLUMNS_LAYOUT => 'candela_blog_three_column_layout'
    ];
