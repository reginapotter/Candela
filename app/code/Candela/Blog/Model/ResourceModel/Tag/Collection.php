...
namespace Candela\Blog\Model\ResourceModel\Tag;

use Candela\Blog\Api\Data\TagInterface;
use Candela\Blog\Model\ResourceModel\Tag as TagResource;
...
class Collection extends \Candela\Blog\Model\ResourceModel\Abstracts\Collection
{
    ...
    public function addCount()
    {
        $this->getSelect()
            ->joinLeft(
                ['posttag' => $this->getTable('candela_blog_posts_tag')],
    ...
    public function addWeightData($store = null)
    {
        ...
        if ($store) {
            ...
            $store = "'" . implode("','", $store) . "'";
            $postStoreTable = $this->getTable('candela_blog_posts_store');
            $this->getSelect()
    ...
    private function joinPostData()
    {
        ...
        $postTagTable = $this->getTable('candela_blog_posts_tag');
    ...
    public function setPostStatusFilter($status)
    {
        ...
        $postTable = $this->getTable('candela_blog_posts');
        $this->getSelect()
