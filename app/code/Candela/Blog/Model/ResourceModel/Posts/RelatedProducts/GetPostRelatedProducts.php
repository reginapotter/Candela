...
use Candela\Blog\Model\Posts\RelatedProducts\Products\CollectionModifierInterface;
...
{
    public const POST_PRODUCT_RELATION_TABLE = 'candela_blog_posts_products';
    public const POSITION_ALIAS = 'candela_blog_position';
