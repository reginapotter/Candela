...
class Categories extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    public const TABLE_NAME = 'candela_blog_categories';

    public const STORE_TABLE_NAME = 'candela_blog_categories_store';
    ...
    public function __construct(
        ...
        \Candela\Blog\Helper\Data $helper,
        $connectionName = null
    ) {
    ...
    private function validateUrlKey($object)
    {
        ...
        $select = $connection->select()->from(
            ...
            ['store' => $this->getTable('candela_blog_categories_store')],
    ...
    public function getStores($id)
    {
        $select = $this->getConnection()->select()
            ->from(
                [$this->getTable('candela_blog_categories_store')],
