...
class Author extends AbstractDb
{
    ...
    public const TABLE_NAME = 'candela_blog_author';

    public const STORE_TABLE_NAME = 'candela_blog_author_store';
    ...
    /**
     * @var \Candela\Blog\Model\AuthorFactory
     */
    ...
    public function __construct(
        ...
        \Candela\Blog\Model\AuthorFactory $authorFactory,
        \Candela\Blog\Model\ResourceModel\Author\CollectionFactory $authorCollectionFactory,
        $connectionName = null
    ) {
     ...
     * @return \Candela\Blog\Api\Data\AuthorInterface
     */
