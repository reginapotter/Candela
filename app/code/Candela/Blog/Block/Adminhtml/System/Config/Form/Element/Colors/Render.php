...
namespace Candela\Blog\Block\Adminhtml\System\Config\Form\Element\Colors;
...
{
    /**
     * @var \Candela\Blog\Helper\Config
     */
    ...
    public function __construct(
        ...
        \Candela\Blog\Helper\Config $helperConfig,
        array $data = [],
    ...
    {
        $this->setTemplate('Candela_Blog::system/config/form/elements/colors.phtml');
        parent::_construct();
    }
