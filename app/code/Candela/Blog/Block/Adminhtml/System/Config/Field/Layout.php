...
namespace Candela\Blog\Block\Adminhtml\System\Config\Field;

use Candela\Blog\Block\Adminhtml\System\Config\Field\Layout\Renderer;
use Candela\Blog\Helper\Data;
use Candela\Blog\Helper\Data\Layout as LayoutHelper;
use Candela\Blog\Model\Source\Layout as LayoutOptions;
    ...
    private function wrapSkinImages(array $blocks)
    {
        ...
        foreach ($blocks as $block) {
            if (isset($block['backend_image'])) {
                ...
                $backendImage = $this->getViewFileUrl('Candela_Blog/' . $backendImage);
