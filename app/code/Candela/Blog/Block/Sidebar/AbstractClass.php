...
class AbstractClass extends \Candela\Blog\Block\Layout\AbstractClass implements BlockInterface
{
    /**
     * @var Settings
     */
    ...
    /**
     * @return \Candela\Blog\Block\Layout\AbstractClass
     */
    ...
    {
        if ($this->hasData('candela_widget_categories')) {
            $widgetCategories = $this->getData('candela_widget_categories');
            if ($widgetCategories) {
        ...
        if ($this->hasData('candela_widget_tags')) {
            $widgetTags = $this->getData('candela_widget_tags');
            if ($widgetTags) {
