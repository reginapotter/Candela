...
namespace Candela\Blog\Block\Html\Header;
...
{
    const CANDELA_BLOG_LOGO_HTML = 'candela/blog/logo_html';
    ...
    {
        $folderName = self::CANDELA_BLOG_LOGO_HTML;
    ...
    /**
     * @return \Candela\Blog\Helper\Settings
     */
