...
class Form extends \Candela\Blog\Block\Comments
{
     ...
     * @var string
     */
    protected $_template = 'Candela_Blog::comments/form.phtml';
    ...
    public function processGdpr(): void
    {
        ...
        $this->_eventManager->dispatch(
            'candela_gdpr_get_checkbox',
            [
                'scope' => \Candela\Blog\Model\Config\GdprBlog::GDPR_BLOG_COMMENT_FORM,
                'result' => $result
            ]
        );
