...
class Category extends \Candela\Blog\Block\Content\Lists implements IdentityInterface
{
    /**
     * @var $category
     */
    ...
    {
        return [\Candela\Blog\Model\Categories::CACHE_TAG . '_' . $this->getCategory()->getId()];
    }
}
