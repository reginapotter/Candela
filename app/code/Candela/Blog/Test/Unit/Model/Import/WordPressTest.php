...
namespace Candela\Blog\Test\Unit\Model\Import;

use Amasty\Base\Model\Serializer;
use Candela\Blog\Model\Import\WordPress;
...
class WordPressTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testSavePost()
    {
        ...
        $postRepository = $this->createMock(\Candela\Blog\Api\PostRepositoryInterface::class);
        $postModel1 = $this->createMock(\Candela\Blog\Api\Data\PostInterface::class);
        $postModel2 = $this->createMock(\Candela\Blog\Api\Data\PostInterface::class);
    ...
    public function testSaveTag()
    {
        ...
        $tagRepository = $this->createMock(\Candela\Blog\Api\TagRepositoryInterface::class);
        $tagModel1 = $this->createMock(\Candela\Blog\Api\Data\TagInterface::class);
        $tagModel2 = $this->createMock(\Candela\Blog\Api\Data\TagInterface::class);
    ...
    public function testSaveCategory()
    {
        ...
        $categoryRepository = $this->createMock(\Candela\Blog\Api\CategoryRepositoryInterface::class);
        $categoryModel1 = $this->createMock(\Candela\Blog\Api\Data\CategoryInterface::class);
        $categoryModel2 = $this->createMock(\Candela\Blog\Api\Data\CategoryInterface::class);
    ...
    {
        $model = $this->createPartialMock(WordPress::class, []);
        $parentCategory = $this->createMock(\Candela\Blog\Api\Data\CategoryInterface::class);
    ...
    public function testSaveAuthor()
    {
        ...
        $authorRepository = $this->createMock(\Candela\Blog\Api\AuthorRepositoryInterface::class);
        $authorModel1 = $this->createMock(\Candela\Blog\Api\Data\AuthorInterface::class);
        $authorModel2 = $this->createMock(\Candela\Blog\Api\Data\AuthorInterface::class);
