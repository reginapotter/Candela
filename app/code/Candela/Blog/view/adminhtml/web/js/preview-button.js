/**
 *  Candela Blog Preview button Component
 */
...
define([
    ...
    $.widget('mage.amBlogPreviewButton', {
        ...
        modalSettings: {
            newPostText: $t('Please make sure Candela Blog cache is enabled. If it is disabled  the'
                + ' preview will not be available.'),
            existPostText: $t('Please note that when Candela Blog cache is disabled the preview may not'
