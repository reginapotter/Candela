...
namespace Candela\Blog\Helper;

use Magento\Framework\App\Filesystem\DirectoryList;

class Image extends \Magento\Framework\App\Helper\AbstractHelper
{
    public const CANDELA_BLOG_PATH = 'candela/blog/';
    ...
    public function __construct(
        ...
        \Candela\Blog\Model\ConfigProvider $configProvider
    ) {
    ...
    public function getImageUrl($name, $path = null)
    {
        ...
        if ($this->ioFile->fileExists($fullPath . $name) && $name != "") {
            ...
            $result = $path . self::CANDELA_BLOG_PATH . $name;
        }
